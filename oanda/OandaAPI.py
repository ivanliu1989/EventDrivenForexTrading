...
class OandaApi(object):
    ...
    def init(self, settingName, token, accountId):
        ...
        self.initFunctionSetting(FUNCTIONCODE_GETACCOUNTINFO, {'path': '/v3/accounts/%s' %self.accountId,
                                                          'method': 'GET'})    
        ...
        self.initFunctionSetting(FUNCTIONCODE_GETPOSITIONS, {'path': '/v3/accounts/%s/positions' %self.accountId,
                                                             'method': 'GET'})     
        ...
        self.initFunctionSetting(FUNCTIONCODE_GETCALENDAR, {'path': '/labs/v3/calendar',
                                                            'method': 'GET'})           
        ...
        self.initFunctionSetting(FUNCTIONCODE_STREAMPRICES, {'path': '/v3/prices',
                                                             'method': 'GET'})  
        
        self.initFunctionSetting(FUNCTIONCODE_STREAMEVENTS, {'path': '/v3/events',
                                                             'method': 'GET'})          
